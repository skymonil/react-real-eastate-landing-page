...
const Projects = () => {
  ...
  const [cardsToShow,setCardsToShow] = useState(1); // Adjust based on your layout requirements
  ...
  return (
    ...
    initial={{ opacity: 0, x: -200 }}
        ...
        viewport={{ once: true }}
      className="container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden items-center"
      id="Projects"
    >
